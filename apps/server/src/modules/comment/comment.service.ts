...
export class CommentService {
  ...
  async create(data: CommentCreateParams): Promise<Comment> {
    return await this.repository.save(data)
  }

  async getList(query?: CommentGetListParams): Promise<PageListResultModel<Comment>> {
  ...
  async update(id: Comment['id'], body: CommentCreateParams): Promise<Comment> {
