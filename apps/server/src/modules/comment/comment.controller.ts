...
export class CommentController {
  ...
  @Get('list')
  @NoPermission()
  async getClientList(@Body() body: CommentGetListParamsDto) {
    return this.service.getList({ aid: body.aid, pageSize: 100 })
  }

  @ApiResult({ description: '新增留言', type: Comment })
  @Post()
  async add(@Body() body: CommentCreateParamsDto) {
  ...
  @Post('add')
  @NoPermission()
  async addForClient(@Body() body: CommentCreateParamsDto) {
    return this.service.create(body)
  }
  ...
  @Put(':id')
  async update(@Param('id') id: Comment['id'], @Body() body: CommentCreateParamsDto) {
