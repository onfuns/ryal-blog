...
import { FileCreateParams, FileGetListParams } from './file.dto'
...
export class FileService {
  ...
  async getList(query: FileGetListParams): Promise<PageListResultModel<File>> {
  ...
  async upload(files: FileCreateParams[], fileCategoryId?: FileCategory['id']): Promise<boolean> {
